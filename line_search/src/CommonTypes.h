...
typedef double (*funcion)(Vector*);

typedef void (*method)(Vector*,funcion,Vector*,Matrix*,Vector*);
typedef int (*condition) (double,Vector*,funcion,Vector*,Vector*);
typedef double (*model)(condition fc,double,Vector*,funcion, Vector*,Vector*,Matrix*);
